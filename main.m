...
img5 = imread('testImages/Images_Training_1/Bygg_2e.png');
img6 = imread('testImages/Husannons_full.png');
img7 = imread('../abobtest/DostojevskyMetro_full_0.png');


%img3 = imread('testImages/Hus_3e.png');
%img4 = imread('testImages/Images_Training_2/Hus_1b.png');
%img5 = imread('testImages/Images_Training_2/Hus_1a.png');
%img6 = imread('testImages/Images_Training_2/Hus_1b.png');
%img7 = imread('testImages/Images_Training_2/Hus_1c.png');
